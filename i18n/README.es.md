...
🎉 El panel de control se abre en `http://localhost:20127`
...
- Panel de control: `http://localhost:20127/dashboard`
- API compatible con OpenAI: `http://localhost:20127/v1`
...
| `PORT`                                               | por defecto del framework                  | Puerto del servicio (`20127` en los ejemplos)                                        |
...
| `BASE_URL`                                           | `http://localhost:20127`                   | URL base interna del lado del servidor usada por los trabajos de sincronización en la nube |
...
- Establece `PORT=20127` y `NEXT_PUBLIC_BASE_URL=http://localhost:20127`
